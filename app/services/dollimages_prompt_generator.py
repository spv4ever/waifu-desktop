...
THEMED_OPTIONS_PATHS = {
    ...
    "river_combinations": Path(
        "resources/config/dollimages_river_prompt_options.json"
    ),
    ...
    "andorra_travel_combinations": Path(
        "resources/config/dollimages_andorra_travel_prompt_options.json"
    ),
