...
class WorkflowService:
    ...
    def load_template(self, *, workflow_key: str = "waifu") -> dict[str, Any]:
        ...
        if workflow_key == "dollimages":
        ...
        elif workflow_key == "undress":
            env_key = "COMFYUI_WORKFLOW_UNDRESS_JSON"
            default_path = "resources/workflows/undress.json"
            ...
            env_key = "COMFYUI_WORKFLOW_KREA2_JSON"
            default_path = "resources/workflows/Krea2.json"
        elif workflow_key == "krea2_v2":
            env_key = "COMFYUI_WORKFLOW_KREA2_V2_JSON"
            default_path = "resources/workflows/krea2_v2.json"
